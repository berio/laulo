    ...
    $('#selectores_licenza input[type="radio"]').change(function(){
        switch ($(this).attr('name')) {
            case 'bm_cousaform_tempo':
                tempo = ' <span>' + $(this).siblings('label').text() + '</span>';
                break;
            case 'bm_cousaform_propositos':
                propositos = ' <span>' + $(this).siblings('label').text() + '</span>';
                break;
            case 'bm_cousaform_destinatarios':
                destinatarios = ' <span>' + $(this).siblings('label').text() + '</span>';
                break;
            case 'bm_cousaform_aportacion':
                aportacion = ' <span>' + $(this).siblings('label').text() + '</span>';
                break;
            default:
        }
        $('.dentro_licenza .seleccions').empty().html(tempo + propositos + destinatarios + aportacion);
        $('#bm_cousaform_licenza_escollida').val($('.dentro_licenza .uso').text() + $('.dentro_licenza .seleccions').text());
    });
